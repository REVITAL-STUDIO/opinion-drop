...
const OpinionModal: React.FC<OpinionModalProps> = ({ opinion, closeModal }) => {
  ...
  return (
    <div className="absolute right-[1.5%] top-[1.5%] min-h-[900px] w-[60%] bg-white p-6 z-20 shadow-lg rounded-md">
      ...
      <div className="relative w-[100%] flex px-[4%]">
        <div className="w-3/4 flex">
          <h2 className="text-7xl font-black mb-4 w-full">
            VIABILITY AS TIME LIMIT
          </h2>
          <p className="absolute flex items-center gap-x-2 bottom-6 left-[55%]">
            Reply
            <IoIosArrowDropdown />
          </p>
        </div>
          ...
          <div>
            <div className="relative z-10 px-[4%]">
              <p className="text-sm">
                ...
                est id urna. Aliquam pellentesque odio metus, sit amet imperdiet
                nisl sodales eu. Quisque viverra nunc nec vestibulum dapibus.
