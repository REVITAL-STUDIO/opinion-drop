    ...
    <section className="absolute h-screen w-full bg-white/90  flex justify-center items-center">
      ...
      <div className="p-4 bg-[#000]/50 xl:w-[30%] md:w-[50%] w-[75%] rounded relative shadow-sm">
        ...
        <div className="flex gap-x-4">
          <div
            {...getRootProps()}
            className="w-[3rem] h-[3rem] relative rounded-full cursor-pointer overflow-hidden bg-white  group"
          >
            <input {...getInputProps()} />
          ...
          <h4 className="px-4 py-2 rounded-full text-white bg-white/40 border w-fit flex justify-center  text-sm items-center">
            General Settings
          </h4>
        </div>
