...
const DebateIt = ({ opinionData, topic, toggleDebateIt }: DebateItProps) => {
  ...
  }, [close, toggleDebateIt]);

  return (
    <section className="w-full h-full top-0 left-0 gap-x-4 flex flex-row-reverse justify-center items-center absolute bg-gradient-to-tr to-purple-500/100 from-red-500/95 z-40">
      <button
